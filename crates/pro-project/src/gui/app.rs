...
const BASE_WINDOW_WIDTH: i32 = 1000;
const BASE_WINDOW_HEIGHT: i32 = 720;
const BASE_MARGIN: i32 = 20;
const BASE_ROW_HEIGHT: i32 = 44;
...
pub struct ProjectManagerApp {
    ...
    #[nwg_control(size: (1000, 720), position: (100, 100), title: "Professional SMART - Project Database Manager", flags: "WINDOW|VISIBLE|MINIMIZE_BOX|MAXIMIZE_BOX")]
...
impl ProjectManagerApp {
    ...
    fn on_init(&self) {
        ...
        // Apply body font to connection labels for readability
        self.lbl_host.set_font(Some(&self.body_font));
        self.lbl_port.set_font(Some(&self.body_font));
        self.lbl_user.set_font(Some(&self.body_font));
        self.lbl_password.set_font(Some(&self.body_font));
        self.lbl_count.set_font(Some(&self.body_font));
