...
// 2025 UX: Generous spacing, clear visual hierarchy, comfortable touch targets
const BASE_WINDOW_WIDTH: i32 = 920;
const BASE_WINDOW_HEIGHT: i32 = 720;
const BASE_MARGIN: i32 = 20;
const BASE_LABEL_WIDTH: i32 = 145;
const BASE_TEXT_WIDTH: i32 = 510;
const BASE_BROWSE_BTN_WIDTH: i32 = 90;
const BASE_ACTION_BTN_WIDTH: i32 = 180;
const BASE_ROW_HEIGHT: i32 = 38;
const BASE_CONTROL_HEIGHT: i32 = 28;
const BASE_BTN_HEIGHT: i32 = 34;
const BASE_SECTION_GAP: i32 = 24;
...
pub struct DataLoaderApp {
    ...
    // Font resources for modern 2025 appearance
    // Larger, more readable fonts with clear hierarchy
    #[nwg_resource(family: "Segoe UI Semibold", size: 17)]
    ...
    // Main Window - sized for modern displays with proper spacing
    #[nwg_control(size: (920, 720), position: (100, 100), title: "Professional SMART - Master Data Loader", flags: "WINDOW|VISIBLE|MINIMIZE_BOX|MAXIMIZE_BOX")]
...
impl DataLoaderApp {
    fn on_init(&self) {
        ...
        // Apply fonts to controls for consistent, modern typography
        ...
        // Apply body font to labels for readability
        self.lbl_org.set_font(Some(&self.body_font));
        self.lbl_region.set_font(Some(&self.body_font));
        self.lbl_facility.set_font(Some(&self.body_font));
        self.lbl_provider.set_font(Some(&self.body_font));
